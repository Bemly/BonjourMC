...
Namespace Utility.Model
	...
	Public Class Version
		...
		Public Sub New(ByVal major As Integer, ByVal minor As Integer, ByVal patch As Integer)
			Me.major = major
			Me.minor = minor
			Me.patch = patch
		End Sub
		...
		' 比较两个版本号
		Public Function CompareTo(ByVal v As Version) As Integer Implements IComparable(Of Version).CompareTo
		...
		Public Shared Operator >(ByVal v1 As Version, ByVal v2 As Version) As Boolean
